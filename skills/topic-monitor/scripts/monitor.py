        ...
        try:
            ...
            result = subprocess.run(
                ...
                env={k: v for k, v in os.environ.items() if k in (
                    ...
                    # Windows requires these for network/socket operations
                    "SystemRoot", "SYSTEMROOT", "SYSTEMDRIVE", "TEMP", "TMP",
                    "USERPROFILE", "APPDATA", "LOCALAPPDATA", "PYTHONIOENCODING"
                )}  # Pass search + Windows system env vars
            )
